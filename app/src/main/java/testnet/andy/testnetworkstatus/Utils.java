...
public class Utils {
    ...
    public static String getDate(long dateTime) {
        ...
        int hour = DateTimeUtils.getHour(dateTime);
        String hourStr = getNumberDigit(hour) == 1 ? "0" + hour : String.valueOf(hour);

        return DateTimeUtils.getYear(dateTime) + "年" + monthStr + "月" + dayStr + "日" + hourStr + "时";
    }
     ...
     * @return
     */
    public static ApplicationInfo getApplicationInfoByPkgName(String packageName) throws PackageManager.NameNotFoundException {
