 ...
 */
public class PowerFragment extends BaseFragment implements LoaderManager.LoaderCallbacks<List<TrafficModel>>, MainActivity.ActivityInterface {
    private final String TAG = PowerFragment.class.getSimpleName();
    public static final String ITEM_NAME="电量详情";
...
//            mainAdapter.notifyDataSetChanged();
            ...
            getLoaderManager().restartLoader(0, b, PowerFragment.this);
